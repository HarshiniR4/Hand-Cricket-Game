...
while(1):
    ...
    try:  #an error comes if it does not find anything in window as it cannot find contour of max area
        ...
        #scoreboard
        cv2.rectangle(frame,(800,100), (1200,600), (0,255,155),3)
        cv2.putText(frame,"Scoreboard", (800,90), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,155))
        cv2.line(frame, (800,200), (1200,200), (0,255,155), 3)
        cv2.line(frame, (1000,100), (1000,600), (0,255,155), 3)
        cv2.putText(frame,"Player", (820,170), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,155))
        cv2.putText(frame,"Bot", (1050,170), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,155))
        #cv2.putText(frame,"Match is of 3 Overs", (450,700), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,155))
    ...
    if bot_status == True:           
        ...
        if player_score > bot_score:
            cv2.putText(frame,"Player wins the game .....", (450,680), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,0,0))

        else:
            cv2.putText(frame,"Bot wins the game .....", (450,680), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,0,0))
